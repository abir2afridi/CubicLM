...
Widget planCard(BuildContext context, bool isDark) {
  ...
  return Container(
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        const Icon(LucideIcons.map, size: 15, color: Color(0xFFF59E0B)),
    ...
    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Row(children: [
        ...
        GestureDetector(
          ...
          child:
              Icon(LucideIcons.x, size: 14, color: Theme.of(context).hintColor),
        ),
      ]),
      ...
      for (final entry in diffs.entries) ...[
        Text(entry.key,
            style: GoogleFonts.firaCode(
                fontSize: 11, fontWeight: FontWeight.w700, color: Dt.accent)),
        ...
        Container(
          ...
          child: SingleChildScrollView(
            child:
                diffLines(entry.value['old'] ?? '', entry.value['new'] ?? ''),
          ),
        ),
        const SizedBox(height: 8),
      ],
