  ...
  Widget _buildModelParametersCard(BuildContext context, bool isDark) {
    return _appleGroupedCard(context, isDark, children: [
      ...
      _modelParameterSlider(
        ...
        divisions: 99,
        safeMax: 100,
        displayValue: '${controller.topK.value}',
        onChanged: (v) => controller.setTopK(v.round()),
    ...
    return _appleGroupedCard(context, isDark, children: [
      ...
      Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(8)),
              child: Obx(() => Text(
                  controller.imageGenCfg.value.toStringAsFixed(1),
                  style: GoogleFonts.plusJakartaSans(
                      fontSize: 13,
                      color: Dt.accent,
                      fontWeight: FontWeight.w800))),
          ...
          const SizedBox(height: 12),
          Obx(() => Slider(
              value: controller.imageGenCfg.value.clamp(1.0, 15.0),
              min: 1,
              max: 15,
              divisions: 28,
      ...
      Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            ...
            const Spacer(),
            Obx(() => Text(
                controller.imageGenSeed.value < 0
                    ? 'Random'
                    : controller.imageGenSeed.value.toString(),
                style: GoogleFonts.plusJakartaSans(
                    fontSize: 13,
                    color: Dt.accent,
                    fontWeight: FontWeight.w800))),
            IconButton(
              ...
              onPressed: () => controller.randomizeImageSeed(),
            ),
            TextButton(
              onPressed: () => controller.setImageGenSeed(-1),
