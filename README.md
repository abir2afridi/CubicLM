...
[![Release](https://img.shields.io/github/v/release/abir2afridi/CubicLM?label=release)](https://github.com/abir2afridi/CubicLM/releases/tag/v1.10.0)
[![Platform](https://img.shields.io/badge/platform-Android%20%7C%20Windows-blue)](https://github.com/abir2afridi/CubicLM/releases/tag/v1.10.0)
...
> **Full notes:** [CHANGELOG.md](CHANGELOG.md) · [Release page](https://github.com/abir2afridi/CubicLM/releases/tag/v1.10.0)
> Web (`dart:ffi`) is tracked for a future release — Android + Windows are the supported targets for `v1.10.0`.
...
### 🌐 CubicWeb Builder (Toolkit) — v1.10.0
