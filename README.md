...
[![Release](https://img.shields.io/github/v/release/abir2afridi/CubicLM?label=release)](https://github.com/abir2afridi/CubicLM/releases/tag/v1.3.0)
[![Platform](https://img.shields.io/badge/platform-Android%20%7C%20Windows-blue)](https://github.com/abir2afridi/CubicLM/releases/tag/v1.3.0)
...
|---|---|---:|---|
| Android (arm64) | `cubiclm-v1.3.0-arm64-v8a.apk` | 61 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.3.0/cubiclm-v1.3.0-arm64-v8a.apk) |
| Android (arm32) | `cubiclm-v1.3.0-armeabi-v7a.apk` | 15 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.3.0/cubiclm-v1.3.0-armeabi-v7a.apk) |
| Android (x86_64) | `cubiclm-v1.3.0-x86_64.apk` | 26 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.3.0/cubiclm-v1.3.0-x86_64.apk) |
| Windows (x64) | `cubiclm-v1.3.0-windows-x64.zip` | 16 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.3.0/cubiclm-v1.3.0-windows-x64.zip) — unzip & run `cubiclm.exe` (WebView2 required) |
| Checksums | `checksums.sha256` | — | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.3.0/checksums.sha256) |

> **Website:** [cubiclm.vercel.app](https://cubiclm.vercel.app) — landing + direct APK / Windows downloads
> **Full notes:** [CHANGELOG.md](CHANGELOG.md) · [Release page](https://github.com/abir2afridi/CubicLM/releases/tag/v1.3.0)
> Web (`dart:ffi`) is tracked for the next release — Android + Windows are the supported targets for `v1.3.0`.
