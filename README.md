...
[![Release](https://img.shields.io/github/v/release/abir2afridi/CubicLM?label=release)](https://github.com/abir2afridi/CubicLM/releases/tag/v1.10.1)
[![Platform](https://img.shields.io/badge/platform-Android%20%7C%20Windows-blue)](https://github.com/abir2afridi/CubicLM/releases/tag/v1.10.1)
...
| --- | --- | ---: | --- |
| Android (arm64) | `cubiclm-v1.10.1-arm64-v8a.apk` | 62 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.10.1/cubiclm-v1.10.1-arm64-v8a.apk) |
| Android (arm32) | `cubiclm-v1.10.1-armeabi-v7a.apk` | 16 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.10.1/cubiclm-v1.10.1-armeabi-v7a.apk) |
| Android (x86_64) | `cubiclm-v1.10.1-x86_64.apk` | 28 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.10.1/cubiclm-v1.10.1-x86_64.apk) |
| Windows (x64) | `cubiclm-v1.10.1-windows-x64.zip` | 17 MB | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.10.1/cubiclm-v1.10.1-windows-x64.zip) — unzip & run `cubiclm.exe` (WebView2 required) |
| Checksums | `checksums.sha256` | — | [GitHub Release](https://github.com/abir2afridi/CubicLM/releases/download/v1.10.1/checksums.sha256) |

> **Website:** [cubiclm.vercel.app](https://cubiclm.vercel.app) — landing + direct APK / Windows downloads
> **Full notes:** [CHANGELOG.md](CHANGELOG.md) · [Release page](https://github.com/abir2afridi/CubicLM/releases/tag/v1.10.1)
> Web (`dart:ffi`) is tracked for a future release — Android + Windows are the supported targets for `v1.10.1`.
...
- **Navigation:** Chat · Explore · Nodes · App Settings
  - **Explore** now has two tabs — **Model Hub** (Local / Online / Skills / MCP scopes) and **Toolkit** (Battle Arena + Slide Maker + CubicWeb Builder widget cards with descriptions)
...
### 🌐 CubicWeb Builder (Toolkit) — v1.10.1
...
- **Plan mode, checkpoints/undo, diff view, responsive viewports** (mobile/tablet/desktop), screenshot-to-code, keyboard shortcuts, 6 project templates
- **Real local runtime** — project detection (static/Vite/Next/Node), source validation, dev-server manager (install, free-port pick, URL parse, health check, crash watcher, restart), real shell terminal
...
- **Next.js pipeline** — atomic writes, byte-for-byte integrity gates, framework adapters, `npm run build` validation, external-browser preview
